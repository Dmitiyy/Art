...
/* harmony import */ var _modules_checkInputes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/checkInputes */ "./src/js/modules/checkInputes.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkInputes__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="name"]');
  Object(_modules_checkInputes__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="message"]');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])(modalState);
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_changeImg__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
/* harmony default export */ __webpack_exports__["default"] = (occo);
...
function calc(state) {
  var sizeBlock = document.querySelectorAll('.optSize'),
  ...
  var sizeBind = document.querySelector('#size'),
      ...
      return regeneratorRuntime.async(function postData$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(fetch('../../assets/question.php', {
                method: 'POST',
                body: formData
              }));
...
function changeImg() {
  ...
  var images = document.querySelectorAll('.sizes-block img');

  function showImg() {
    blocks.forEach(function (item, i) {
      item.addEventListener('mouseover', function () {
        images[i].src = "assets/img/sizes-".concat(i + 1, "-1.png");
  ...
  function hideImg() {
    blocks.forEach(function (item, i) {
      item.addEventListener('mouseout', function () {
        images[i].src = "assets/img/sizes-".concat(i + 1, ".png");
        this.querySelectorAll('p:not(.sizes-hit)').forEach(function (p) {
...
/***/ "./src/js/modules/checkInputes.js":
/*!****************************************!*\
  !*** ./src/js/modules/checkInputes.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (checkInp);
        ...
        return regeneratorRuntime.async(function post$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return regeneratorRuntime.awrap(fetch('http://localhost:3000/users', {
                  method: 'POST',
                  headers: {
  ...
  function ps() {
    ...
    form.forEach(function (item) {
      item.addEventListener('submit', function (e) {
        e.preventDefault();
        var stMes = document.createElement('div');
...
function modals() {
  var modalWindow = document.querySelector('.popup-design');
  var btnModalOpen = document.querySelectorAll('.btn_open');
  var btnModalClose = document.querySelectorAll('.popup-close');
  var phoneLinkBtn = document.querySelectorAll('.button-consultation');
  var imgGift = document.querySelector('.fixed-gift');
  var btnPressed = false;

  function modal() {
    var destroy = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
    var scroll = calcScroll();
    btnModalOpen.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        imgGift.style.marginRight = "".concat(scroll, "px");
      });
    });
    btnModalClose.forEach(function (item) {
      item.addEventListener('click', function () {
    ...
    phoneLinkBtn.forEach(function (item) {
      item.addEventListener('click', function (e) {
        if (e.target) {
          e.preventDefault();
        }
...
function showMoreStyles(trigger, wrapper) {
  var btnMore = document.querySelector(trigger);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Fetch ".concat(url, " status ").concat(result.status));
